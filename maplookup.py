...
HL_Previous_season_CFG = config['Current_RGL_Settings']['HL_Previous_season']
...
##Now check the ID to see if it is 6s or HL
...
for Thing in RGL_Season_Type:
    ...
    if "HL " in RGL_Season_Type:
        break
    else:
        print(str(RGL_Season_ID) + " is 6s, skipping")
        RGL_Season_ID -= 1
        RGL_API_Season_Search_URL = "https://api.rgl.gg/v0/seasons/" + str(RGL_Season_ID)
